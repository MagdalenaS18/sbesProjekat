...
namespace Manager {
    ...
    internal class AuditEventFile {
        ...
        /// <summary>
        ///   Looks up a localized string similar to User {0} failed with adding items to the Database. Reason: {2}..
        /// </summary>
        internal static string AddingToDatabaseFailure {
            get {
                return ResourceManager.GetString("AddingToDatabaseFailure", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to User {0} successfully added item to the Database..
        /// </summary>
        internal static string AddingToDatabaseSuccess {
            get {
                return ResourceManager.GetString("AddingToDatabaseSuccess", resourceCulture);
            }
        }
